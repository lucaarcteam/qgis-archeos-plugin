...
# Form implementation generated from reading ui file '/Users/pyarchinit/.qgis/python/plugins/pyarchinit/modules/gui/pyarchinit_inventario_reperti_ui.ui'
#
# Created: Thu Jan 28 21:26:07 2010
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_num_inv = QtGui.QLineEdit(Dialog)
        self.lineEdit_num_inv.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lineEdit_num_inv.setFont(font)
        self.lineEdit_num_inv.setObjectName("lineEdit_num_inv")
        ...
        self.comboBox_tipo_reperto = QtGui.QComboBox(self.tab)
        ...
        self.comboBox_tipo_reperto.setObjectName("comboBox_tipo_reperto")
        self.comboBox_tipo_reperto.addItem("")
        self.comboBox_tipo_reperto.addItem("")
        self.comboBox_tipo_reperto.addItem("")
        self.comboBox_tipo_reperto.addItem("")
        self.comboBox_tipo_reperto.addItem("")
        ...
        self.comboBox_tipo_reperto.addItem("")
        self.comboBox_tipo_reperto.addItem("")
        self.gridLayout_7.addWidget(self.comboBox_tipo_reperto, 1, 0, 3, 3)
        self.comboBox_criterio_schedatura = QtGui.QComboBox(self.tab)
        ...
        self.comboBox_criterio_schedatura.setObjectName("comboBox_criterio_schedatura")
        self.comboBox_criterio_schedatura.addItem("")
        self.comboBox_criterio_schedatura.addItem("")
        self.comboBox_criterio_schedatura.addItem("")
        self.comboBox_criterio_schedatura.addItem("")
        self.comboBox_criterio_schedatura.addItem("")
        self.gridLayout_7.addWidget(self.comboBox_criterio_schedatura, 1, 3, 3, 2)
        self.comboBox_definizione = QtGui.QComboBox(self.tab)
        ...
        self.comboBox_definizione.setObjectName("comboBox_definizione")
        self.comboBox_definizione.addItem("")
        self.comboBox_definizione.addItem("")
        self.comboBox_definizione.addItem("")
        self.comboBox_definizione.addItem("")
        self.comboBox_definizione.addItem("")
        self.gridLayout_7.addWidget(self.comboBox_definizione, 5, 0, 2, 3)
        ...
        self.gridLayout_7.addWidget(self.label_5, 4, 3, 1, 1)
        ...
        self.textEdit_descrizione_reperto.setObjectName("textEdit_descrizione_reperto")
        ...
        self.gridLayout_11.addWidget(self.line_2, 0, 2, 2, 1)
        self.gridLayout_8 = QtGui.QGridLayout()
        self.gridLayout_8.setObjectName("gridLayout_8")
        self.lineEdit_area = QtGui.QLineEdit(self.tab)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lineEdit_area.setFont(font)
        self.lineEdit_area.setObjectName("lineEdit_area")
        self.gridLayout_8.addWidget(self.lineEdit_area, 0, 0, 1, 2)
        ...
        self.lineEdit_us = QtGui.QLineEdit(self.tab)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lineEdit_us.setFont(font)
        self.lineEdit_us.setObjectName("lineEdit_us")
        self.gridLayout_9.addWidget(self.lineEdit_us, 0, 0, 1, 2)
        ...
        self.gridLayout_15.addLayout(self.gridLayout_11, 0, 0, 3, 1)
        ...
        self.gridLayout_15.addLayout(self.gridLayout_12, 0, 1, 1, 1)
        ...
        self.lineEdit_nr_cassa = QtGui.QLineEdit(self.tab)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lineEdit_nr_cassa.setFont(font)
        self.lineEdit_nr_cassa.setObjectName("lineEdit_nr_cassa")
        self.gridLayout_13.addWidget(self.lineEdit_nr_cassa, 0, 2, 1, 1)
        ...
        self.checkBox_lavato = QtGui.QCheckBox(self.tab)
        self.checkBox_lavato.setObjectName("checkBox_lavato")
        self.gridLayout_13.addWidget(self.checkBox_lavato, 0, 0, 1, 1)
        self.gridLayout_15.addLayout(self.gridLayout_13, 1, 1, 1, 1)
        ...
        self.lineEdit_luogo_conservazione = QtGui.QLineEdit(self.tab)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lineEdit_luogo_conservazione.setFont(font)
        self.lineEdit_luogo_conservazione.setObjectName("lineEdit_luogo_conservazione")
        self.gridLayout_14.addWidget(self.lineEdit_luogo_conservazione, 0, 1, 1, 1)
        self.gridLayout_15.addLayout(self.gridLayout_14, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtGui.QApplication.translate("Dialog", "pyArchInit Gestione Scavi - Inventario materiali", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.lineEdit_num_inv.setText(QtGui.QApplication.translate("Dialog", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("Dialog", "Sito", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("Dialog", "N° Inventairio", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_tipo_reperto.setItemText(0, QtGui.QApplication.translate("Dialog", "Inserisci un valore", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_tipo_reperto.setItemText(1, QtGui.QApplication.translate("Dialog", "Malacofauna", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_tipo_reperto.setItemText(2, QtGui.QApplication.translate("Dialog", "Reperto cartaceo", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_tipo_reperto.setItemText(3, QtGui.QApplication.translate("Dialog", "Reperto ceramico", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_tipo_reperto.setItemText(4, QtGui.QApplication.translate("Dialog", "Reperto ligneo", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_tipo_reperto.setItemText(5, QtGui.QApplication.translate("Dialog", "Reperto metallico", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_tipo_reperto.setItemText(6, QtGui.QApplication.translate("Dialog", "Reperto osseo lavorato", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_tipo_reperto.setItemText(7, QtGui.QApplication.translate("Dialog", "Reperto osteologico animale", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_tipo_reperto.setItemText(8, QtGui.QApplication.translate("Dialog", "Reperto osteologico umano", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_tipo_reperto.setItemText(9, QtGui.QApplication.translate("Dialog", "Reperto vitreo", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_criterio_schedatura.setItemText(0, QtGui.QApplication.translate("Dialog", "Acroma grezza", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_criterio_schedatura.setItemText(1, QtGui.QApplication.translate("Dialog", "Acroma depurata", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_criterio_schedatura.setItemText(2, QtGui.QApplication.translate("Dialog", "Maiolica arcaica", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_criterio_schedatura.setItemText(3, QtGui.QApplication.translate("Dialog", "Vernice nera", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_criterio_schedatura.setItemText(4, QtGui.QApplication.translate("Dialog", "Terra sigillata", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_definizione.setItemText(0, QtGui.QApplication.translate("Dialog", "Bicchiere", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_definizione.setItemText(1, QtGui.QApplication.translate("Dialog", "Boccale", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_definizione.setItemText(2, QtGui.QApplication.translate("Dialog", "Brocca", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_definizione.setItemText(3, QtGui.QApplication.translate("Dialog", "Olla", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_definizione.setItemText(4, QtGui.QApplication.translate("Dialog", "Piatto", None, QtGui.QApplication.UnicodeUTF8))
        self.label_4.setText(QtGui.QApplication.translate("Dialog", "Tipo reperto", None, QtGui.QApplication.UnicodeUTF8))
        self.label_5.setText(QtGui.QApplication.translate("Dialog", "Criterio schedatura", None, QtGui.QApplication.UnicodeUTF8))
        self.label_7.setText(QtGui.QApplication.translate("Dialog", "Definizione", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_14.setText(QtGui.QApplication.translate("Dialog", "Dati stratigrafici", None, QtGui.QApplication.UnicodeUTF8))
        self.label_25.setText(QtGui.QApplication.translate("Dialog", "Area", None, QtGui.QApplication.UnicodeUTF8))
        self.label_26.setText(QtGui.QApplication.translate("Dialog", "US", None, QtGui.QApplication.UnicodeUTF8))
        self.label_15.setText(QtGui.QApplication.translate("Dialog", "Dati magazzino", None, QtGui.QApplication.UnicodeUTF8))
        self.label_32.setText(QtGui.QApplication.translate("Dialog", "Nr. Cassa", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_lavato.setText(QtGui.QApplication.translate("Dialog", "Lavato", None, QtGui.QApplication.UnicodeUTF8))
        self.label_33.setText(QtGui.QApplication.translate("Dialog", "Luogo di conservazione", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QtGui.QApplication.translate("Dialog", "Dati descrittivi - Riferimenti stratigrafici - Riferimenti magazzino", None, QtGui.QApplication.UnicodeUTF8))
